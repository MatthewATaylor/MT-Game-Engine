...
namespace mtge {
	...
	protected:
		...
		Shape(glm::vec3 pos, glm::vec3 dimensions, const float *VERTICES, const unsigned int VERTICES_SIZE, Shader *shader, const bool POSITION_ONLY_VERTICES, const ShapeType TYPE);
		void transform();
