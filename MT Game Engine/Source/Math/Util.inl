...
namespace mtge {
	namespace math {
		...
		template<typename T>
		T Util::determinant(const Mat<T, 2, 2> &matrix) {
			return
		...
		template<typename T>
		T Util::determinant(const Mat<T, 3, 3> &matrix) {
			T det = 0;
		...
		template<typename T>
		Mat<T, 3, 3> Util::MatGen::rotation(T rotationRadians) {
		...
		template<typename T>
		Mat<T, 4, 4> Util::MatGen::rotation(const Vec<T, 3> &rotationRadians) {
		...
		template<typename T>
		Mat<T, 4, 4> Util::MatGen::rotationAboutAxis(const Vec<T, 3> &axis, T rotationRadians) {
		...
		template<typename T>
		Mat<T, 3, 3> Util::MatGen::normal(const Mat<T, 4, 4> &modelMatrix) {
		...
		template<typename T>
		Mat<T, 2, 2> Util::MatGen::inverse(const Mat<T, 2, 2> &original) {
		...
		template<typename T>
		Mat<T, 3, 3> Util::MatGen::inverse(const Mat<T, 3, 3> &original) {
		...
		template<typename T>
		Mat<T, 4, 4> Util::MatGen::inverse(const Mat<T, 4, 4> &original) {
			Mat<T, 4, 4> outputMatrix;
